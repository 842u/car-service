...
export async function carsOwnershipsAddOnMutate(
  ...
  queryClient.setQueryData(
    ...
    (currentQueryData: CarOwnership[]) => {
      ...
      const updatedQuery: CarOwnership[] = currentQueryData.map(
        (ownership) => ({ ...ownership }),
      );
...
export function carsOwnershipsAddOnError(
  ...
  if (currentQueryData) {
    let updatedQueryData: CarOwnership[] = currentQueryData.map(
      (ownership) => ({ ...ownership }),
    );
...
export async function carsOwnershipsUpdateOnMutate(
  ...
  queryClient.setQueryData(
    ...
    (currentQueryData: CarOwnership[]) => {
      ...
      const updatedQuery: CarOwnership[] = currentQueryData.map((ownership) => {
...
export function carsOwnershipsUpdateOnError(
  ...
  if (currentQueryData) {
    const updatedQueryData: CarOwnership[] = currentQueryData.map(
      (ownership) => {
