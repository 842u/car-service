          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="even:bg-alpha-grey-100">
                ...
                <td className="text-right">{car.custom_name}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">Brand:</th>
                <td className="text-right">{car.brand}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
              ...
              <tr className="even:bg-alpha-grey-100">
                ...
                <td className="text-right">{car.production_year}</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="even:bg-alpha-grey-100">
                ...
                <td className="text-right">{car.license_plates}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">VIN:</th>
                <td className="text-right">{car.vin}</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="even:bg-alpha-grey-100">
                ...
                <td className="text-right">{car.engine_capacity}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">Fuel type:</th>
                <td className="text-right">{car.fuel_type}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">Additional fuel type:</th>
                <td className="text-right">{car.additional_fuel_type}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">Drive type:</th>
                <td className="text-right">{car.drive_type}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">Transmission type:</th>
                <td className="text-right">{car.transmission_type}</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr className="even:bg-alpha-grey-100">
                ...
                <td className="text-right">{car.mileage}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                <th className="text-left font-normal">Insurance expiration:</th>
                <td className="text-right">{car.insurance_expiration}</td>
              </tr>
              <tr className="even:bg-alpha-grey-100">
                ...
                <td className="text-right">
                  {car.technical_inspection_expiration}
                </td>
              </tr>
            </tbody>
          </table>
