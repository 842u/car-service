...
export function NavMenu({ isActive }: NavMenuProps) {
  return (
    <nav
      className={twJoin(
        'absolute left-0 top-0 z-10 flex h-screen w-screen justify-center bg-light-500 transition-all dark:bg-dark-500 lg:static lg:h-full lg:w-auto lg:translate-y-0 lg:items-center lg:justify-center lg:bg-none lg:text-xs lg:opacity-100',
