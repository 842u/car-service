...
REVOKE ALL ON FUNCTION create_new_car(text, text, text, text, text, fuel, fuel,
  transmission, drive, int, int, int, date) FROM public;

REVOKE ALL ON FUNCTION create_new_car(text, text, text, text, text, fuel, fuel,
  transmission, drive, int, int, int, date) FROM authenticated;

REVOKE ALL ON FUNCTION create_new_car(text, text, text, text, text, fuel, fuel,
  transmission, drive, int, int, int, date) FROM anon;

GRANT EXECUTE ON FUNCTION create_new_car(text, text, text, text, text, fuel,
  fuel, transmission, drive, int, int, int, date) TO authenticated;
